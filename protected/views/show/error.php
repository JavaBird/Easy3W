...
<BODY topMargin=20>
  <TABLE cellSpacing=0 width=600 align=center border=0 cepadding="0">
    <TBODY>
      <TR colspan="2">
        <TD vAlign=top align=middle><IMG height=100 src="<?php echo $this->assetsUrl;?>/images/404.jpg"
          width=100 border=0>
          <TD>
            <TD>
              <H1>无法找到该页</H1>
              ...
              <UL>
                <LI>确保浏览器的地址栏中显示的网站地址的拼写和格式正确无误。
                  ...
                  <!--   <P>☉ www.kfyu.netru Freedom LiFe 网：
                      <UL>
                        <LI><A href="http://www.kfyu.net.ru/"
                        target=_blank>http://www.kfyu.net.ru</A></LI>
                      </UL> -->
                      <HR noShade SIZE=0>
                    <P>☉ 如果您对本站有任何疑问、意见、建议、咨询，请联系管理员QQ:123456789</A>
                    <BR>
                    &nbsp;&nbsp;&nbsp;<BR>
                  </P>
